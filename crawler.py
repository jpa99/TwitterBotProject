...
class UserCrawler(object):
    ...
    def __init__(self, prefix = None, userlist = None, filename = None, startover = False, simplecrawl = False, only200 = True):
    ...
    def searchUser(self):
        ...
        # if pickle file exist, no need to search
        print self.filename
    ...
    def test_malicious_url(self, tweet):
        # Basically we get the text of the url link imbedded in a tweet, 
        # and compare the content with tweet['text']
        #
        # If contents overlap, it's fine. If not, this can be a malicious link
        #
        #
        pass
...
def load_file(filename):
    ...
    with open(filename) as f:
        for line in f:
            jsonFields.append(json.loads(line))
...
if __name__ == '__main__':
    ...
    userlist = [2874845313]
    print "length of userlist is --> ", len(userlist)
    ...
    #print len(set([t['text'] for t in result]))
    #for t in result:
    #if 'superbowl' in t['text']:
    #        print t['text'].encode('utf-8', 'ignore')
